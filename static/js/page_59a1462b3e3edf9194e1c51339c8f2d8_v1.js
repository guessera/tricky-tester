...
; /* Start:"a:4:{s:4:"full";s:89:"/local/components/harlamoff/test.view/Process/templates/.default/script.js?16358608342272";s:6:"source";s:74:"/local/components/harlamoff/test.view/Process/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
"use strict";
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:92:"/local/components/harlamoff/test.view/ResultTest/templates/.default/script.js?16554677437282";s:6:"source";s:77:"/local/components/harlamoff/test.view/ResultTest/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:81:"/local/components/harlamoff/test.view/templates/.default/script.js?16458153586663";s:6:"source";s:66:"/local/components/harlamoff/test.view/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
"use strict";
		...
		init : function( options ) {
			...
			if ( ! data ) {
				...
				$("body").on("click", ".js__btn-back", function(e){
					...
					//отправляем параметр back для обработки PHP
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:77:"/local/components/harlamoff/popup/templates/.default/script.js?16480254793000";s:6:"source";s:62:"/local/components/harlamoff/popup/templates/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
"use strict";

// (function(w, d, n, s, t) {
	$(".ts__form").on("showFullAd", function(e){
		window.yaContextCb.push(()=>{
			Ya.Context.AdvManager.render({
				renderTo: 'yandex_rtb_R-A-266642-29',
				blockId: 'R-A-266642-29'
			})
		})
	});
// })(this, this.document, "yandexContextAsyncCallbacks");
...
(function( $ ){
	...
	var methods = {
		init : function( options ) {
			...
			// Если плагин ещё не проинициализирован
			if (!data ) {
				// если тест на время выводить только webpush
				console.log(window.isShowTimer);
				if(window.isShowTimer == false){
					if(!isShowFullAd){
						isShowFullAd = true;
						$(".ts__form").trigger('showFullAd');
					}
					return;
					...
					// // webPush
					// if (!Cookies.get('webPushSubscribeShow') && !isTokenSentToServer() ) {
					// 	console.log('webPushSubscribeShow');
					// 	Cookies.set('webPushSubscribeShow', true, {
					// 		expires: 1, //дни
					// 		path: '/'
					// 	});
					//
					...
					//
					// // regFormShow
					// if (!Cookies.get('regFormShow') && !userIsAuthorized ) {
					// 	Cookies.set('regFormShow', true, {
					// 		expires: 1, //дни
					// 		path: '/'
					// 	});
					// 	$.fancybox.open( $("#fb-reg"), {touch: false} );
					// 	// console.log('regFormShow');
					// 	return;
					// }
					//
					// // socSubscribe
					// if (!Cookies.get('socSubscribeShow')) {
					// 	$("body").trigger('initVkPopup'); // можно использовать события
					//
					// 	Cookies.set('socSubscribeShow', true, {
					// 		expires: 10, //дни
					// 		path: '/'
					// 	});
					// 	$.fancybox.open( $("#fb-soc-subscribe"), {touch: false} );
					// 	// console.log('socSubscribeShow');
					// 	return;
					// }
					//
					// // emailSubscribe
					// if (!Cookies.get('emailSubscribeShow') && !Cookies.get('BITRIX_SM_SENDER_SUBSCR_EMAIL') && !userIsAuthorized) {
					// 	Cookies.set('emailSubscribeShow', true, {
					// 		expires: 1, //дни
					// 		path: '/'
					// 	});
					// 	$.fancybox.open( $("#fb-email-subscribe"), {touch: false} );
					// 	// console.log('emailSubscribeShow');
					// 	return;
					// }
				}else{
					// console.log('other');
	...
	$.fn.Popup = function( method ) {
		...
		if ( methods[method] ) {
			...
			$.error( 'Метод с именем ' +  method + ' не существует для $.Popup' );
		}    
	};
...
/* End */
;; /* /local/components/harlamoff/test.view/Process/templates/.default/script.js?16358608342272*/
; /* /local/components/harlamoff/test.view/ResultTest/templates/.default/script.js?16554677437282*/
; /* /local/components/harlamoff/test.view/templates/.default/script.js?16458153586663*/
...
; /* /local/components/harlamoff/popup/templates/.default/script.js?16480254793000*/
