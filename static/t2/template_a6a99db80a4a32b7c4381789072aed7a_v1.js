...
; /* Start:"a:4:{s:4:"full";s:49:"/local/templates/main/js/output.js?15990511587316";s:6:"source";s:34:"/local/templates/main/js/output.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
var global=function(t){var e={};function r(n){if(e[n])return e[n].exports;var o=e[n]={i:n,l:!1,exports:{}};return t[n].call(o.exports,o,o.exports,r),o.l=!0,o.exports}return r.m=t,r.c=e,r.d=function(t,e,n){r.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:n})},r.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},r.t=function(t,e){if(1&e&&(t=r(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var o in t)r.d(n,o,function(e){return t[e]}.bind(null,o));return n},r.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return r.d(e,"a",e),e},r.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},r.p="",r(r.s=1)}([function(t,e,r){(function(t,e,r){!function(t){"use strict";var n,o=/^[a-z]+:/,i=/[-a-z0-9]+(\.[-a-z0-9])*:\d+/i,u=/\/\/(.*?)(?::(.*?))?@/,a=/^win/i,s=/:$/,c=/^\?/,p=/^#/,h=/(.*\/)/,l=/^\/{2,}/,f=/(^\/?)/,d=/'/g,y=/%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi,v=/%([cd][0-9a-f])%([89ab][0-9a-f])/gi,g=/%([0-7][0-9a-f])/gi,m=/\+/g,b=/^\w:$/,w=/[^/#?]/,T="undefined"==typeof window&&void 0!==e&&!0,q=!T&&t.navigator&&t.navigator.userAgent&&~t.navigator.userAgent.indexOf("MSIE"),j=T?t.require:null,S={protocol:"protocol",host:"hostname",port:"port",path:"pathname",query:"search",hash:"hash"},_={ftp:21,gopher:70,http:80,https:443,ws:80,wss:443};function x(){return T?n=n||"file://"+(r.platform.match(a)?"/":"")+j("fs").realpathSync("."):"about:srcdoc"===document.location.href?self.parent.document.location.href:document.location.href}function A(t){return encodeURIComponent(t).replace(d,"%27")}function O(t){return(t=(t=(t=t.replace(m," ")).replace(y,(function(t,e,r,n){var o=parseInt(e,16)-224,i=parseInt(r,16)-128;if(0==o&&i<32)return t;var u=(o<<12)+(i<<6)+(parseInt(n,16)-128);return 65535<u?t:String.fromCharCode(u)}))).replace(v,(function(t,e,r){var n=parseInt(e,16)-192;if(n<2)return t;var o=parseInt(r,16)-128;return String.fromCharCode((n<<6)+o)}))).replace(g,(function(t,e){return String.fromCharCode(parseInt(e,16))}))}function I(t){for(var e=t.split("&"),r=0,n=e.length;r<n;r++){var o=e[r].split("="),i=decodeURIComponent(o[0].replace(m," "));if(i){var u=void 0!==o[1]?O(o[1]):null;void 0===this[i]?this[i]=u:(this[i]instanceof Array||(this[i]=[this[i]]),this[i].push(u))}}}function P(t,e){!function(t,e,r){var n,a,d;e=e||x(),T?n=j("url").parse(e):(n=document.createElement("a")).href=e;var y,v,g=(v={path:!0,query:!0,hash:!0},(y=e)&&o.test(y)&&(v.protocol=!0,v.host=!0,i.test(y)&&(v.port=!0),u.test(y)&&(v.user=!0,v.pass=!0)),v);for(a in d=e.match(u)||[],S)g[a]?t[a]=n[S[a]]||"":t[a]="";if(t.protocol=t.protocol.replace(s,""),t.query=t.query.replace(c,""),t.hash=O(t.hash.replace(p,"")),t.user=O(d[1]||""),t.pass=O(d[2]||""),t.port=_[t.protocol]==t.port||0==t.port?"":t.port,!g.protocol&&w.test(e.charAt(0))&&(t.path=e.split("?")[0].split("#")[0]),!g.protocol&&r){var m=new P(x().match(h)[0]),b=m.path.split("/"),A=t.path.split("/"),C=["protocol","user","pass","host","port"],E=C.length;for(b.pop(),a=0;a<E;a++)t[C[a]]=m[C[a]];for(;".."===A[0];)b.pop(),A.shift();t.path=("/"!==e.charAt(0)?b.join("/"):"")+"/"+A.join("/")}t.path=t.path.replace(l,"/"),q&&(t.path=t.path.replace(f,"/")),t.paths(t.paths()),t.query=new I(t.query)}(this,t,!e)}I.prototype.toString=function(){var t,e,r="",n=A;for(t in this){var o=this[t];if(!(o instanceof Function||void 0===o))if(o instanceof Array){var i=o.length;if(!i){r+=(r?"&":"")+n(t)+"=";continue}for(e=0;e<i;e++){var u=o[e];void 0!==u&&(r+=r?"&":"",r+=n(t)+(null===u?"":"="+n(u)))}}else r+=r?"&":"",r+=n(t)+(null===o?"":"="+n(o))}return r},P.prototype.clearQuery=function(){for(var t in this.query)this.query[t]instanceof Function||delete this.query[t];return this},P.prototype.queryLength=function(){var t=0;for(var e in this.query)this.query[e]instanceof Function||t++;return t},P.prototype.isEmptyQuery=function(){return 0===this.queryLength()},P.prototype.paths=function(t){var e,r="",n=0;if(t&&t.length&&t+""!==t){for(this.isAbsolute()&&(r="/"),e=t.length;n<e;n++)t[n]=!n&&b.test(t[n])?t[n]:A(t[n]);this.path=r+t.join("/")}for(n=0,e=(t=("/"===this.path.charAt(0)?this.path.slice(1):this.path).split("/")).length;n<e;n++)t[n]=O(t[n]);return t},P.prototype.encode=A,P.prototype.decode=O,P.prototype.isAbsolute=function(){return this.protocol||"/"===this.path.charAt(0)},P.prototype.toString=function(){return(this.protocol&&this.protocol+"://")+(this.user&&A(this.user)+(this.pass&&":"+A(this.pass))+"@")+(this.host&&this.host)+(this.port&&":"+this.port)+(this.path&&this.path)+(this.query.toString()&&"?"+this.query)+(this.hash&&"#"+A(this.hash))},t[t.exports?"exports":"Url"]=P}(t.exports?t:window)}).call(this,r(2)(t),r(3),r(4))},function(t,e,r){"use strict";r.r(e);var n=r(0),o=new(r.n(n).a);"start"==o.query.test&&(delete o.query.test,history.replaceState("","",o),$((function(){$(".js__ts-start").length&&$(".js__ts-start").click(),$(".js__ts-continue").length&&$(".js__ts-continue").click()})))},function(t,e){t.exports=function(t){return t.webpackPolyfill||(t.deprecate=function(){},t.paths=[],t.children||(t.children=[]),Object.defineProperty(t,"loaded",{enumerable:!0,get:function(){return t.l}}),Object.defineProperty(t,"id",{enumerable:!0,get:function(){return t.i}}),t.webpackPolyfill=1),t}},function(t,e){var r;r=function(){return this}();try{r=r||new Function("return this")()}catch(t){"object"==typeof window&&(r=window)}t.exports=r},function(t,e){var r,n,o=t.exports={};function i(){throw new Error("setTimeout has not been defined")}function u(){throw new Error("clearTimeout has not been defined")}function a(t){if(r===setTimeout)return setTimeout(t,0);if((r===i||!r)&&setTimeout)return r=setTimeout,setTimeout(t,0);try{return r(t,0)}catch(e){try{return r.call(null,t,0)}catch(e){return r.call(this,t,0)}}}!function(){try{r="function"==typeof setTimeout?setTimeout:i}catch(t){r=i}try{n="function"==typeof clearTimeout?clearTimeout:u}catch(t){n=u}}();var s,c=[],p=!1,h=-1;function l(){p&&s&&(p=!1,s.length?c=s.concat(c):h=-1,c.length&&f())}function f(){if(!p){var t=a(l);p=!0;for(var e=c.length;e;){for(s=c,c=[];++h<e;)s&&s[h].run();h=-1,e=c.length}s=null,p=!1,function(t){if(n===clearTimeout)return clearTimeout(t);if((n===u||!n)&&clearTimeout)return n=clearTimeout,clearTimeout(t);try{n(t)}catch(e){try{return n.call(null,t)}catch(e){return n.call(this,t)}}}(t)}}function d(t,e){this.fun=t,this.array=e}function y(){}o.nextTick=function(t){var e=new Array(arguments.length-1);if(arguments.length>1)for(var r=1;r<arguments.length;r++)e[r-1]=arguments[r];c.push(new d(t,e)),1!==c.length||p||a(f)},d.prototype.run=function(){this.fun.apply(null,this.array)},o.title="browser",o.browser=!0,o.env={},o.argv=[],o.version="",o.versions={},o.on=y,o.addListener=y,o.once=y,o.off=y,o.removeListener=y,o.removeAllListeners=y,o.emit=y,o.prependListener=y,o.prependOnceListener=y,o.listeners=function(t){return[]},o.binding=function(t){throw new Error("process.binding is not supported")},o.cwd=function(){return"/"},o.chdir=function(t){throw new Error("process.chdir is not supported")},o.umask=function(){return 0}}]);
/* End */
;
; /* Start:"a:4:{s:4:"full";s:77:"/local/templates/main/js/form-styler/jquery.formstyler.min.js?152243394718307";s:6:"source";s:61:"/local/templates/main/js/form-styler/jquery.formstyler.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:72:"/local/templates/main/js/fancybox/jquery.fancybox.min.js?152455593161486";s:6:"source";s:56:"/local/templates/main/js/fancybox/jquery.fancybox.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
// ==================================================
// fancyBox v3.3.5
//
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:74:"/local/templates/main/components/bitrix/menu/main/script.js?16444986731410";s:6:"source";s:59:"/local/templates/main/components/bitrix/menu/main/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
(function() {
	var body = $(".body"),
		menuTrigger = $(".icon-side-menu"),
		sideMenu = $(".side-menu");

    menuTrigger.on("click touchstart", function(e){
        e.preventDefault();
        $(this).toggleClass('js-open');
        sideMenu.toggleClass('js-side-menu-opened');
        showNavItemsAnimation(); 
        body.toggleClass('js-opened-menu');
    })

    $('.side-menu__item_plus').on("click touchstart", function(e){
        e.preventDefault();
        $(this).parent('.side-menu__main-list_item').toggleClass('js-opened-subnav').siblings().removeClass('js-opened-subnav');      
    })

    function showNavItemsAnimation() {
        var navItems = $('.side-menu__main-list_item');
        var delayValue = 0;
        for (var i = 0; i < navItems.length; i++) {
            delayValue += 0.05;
            navItems[i].style.transitionDelay = delayValue + "s";
        }
    }

     $(document).on("click touchstart", function(e){
        var triggerElem = $(".side-menu, .icon-side-menu__wrap");

        if(triggerElem !== e.target && !triggerElem.has(e.target).length){
            body.removeClass('js-opened-menu');
			sideMenu.removeClass('js-side-menu-opened');
			menuTrigger.removeClass('js-open');
        }   
    })
})();

//Lang window
$(".fb-lang-link").on("click", function(e){
    if (e.cancelable) e.preventDefault();
    $.fancybox.open( $("#fb-lang"), {touch: false} );
});


/* End */
;
; /* Start:"a:4:{s:4:"full";s:62:"/local/components/bitrix/search.title/script.js?15224339479469";s:6:"source";s:47:"/local/components/bitrix/search.title/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
function JCTitleSearch(arParams)
{
	...
	this.Init = function()
	{
		...
		this.RESULT = document.getElementById("search-wrap-result");
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:81:"/local/components/bitrix/search.title/templates/mini_head/script.js?1597683935804";s:6:"source";s:67:"/local/components/bitrix/search.title/templates/mini_head/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
// $(function(){
// 	var $store_search = $(".search-input_inp__a"),
// 		$store_search_form = $(".search-input__wrp"),
// 		$store_search_inp = $(".search-input_inp"),
// 		$store_search_span = $(".search-input_inp__span");
// 	$(".search-input_inp__a, .search-input_inp__span").on("click touchstart", function(){
// 		if($store_search.hasClass("active")){
// 			if($store_search_inp.val().length > 1 ){
// 				$store_search_form.submit();
// 			}
// 		}else{
// 			$store_search_inp.show(100).focus();
// 			$store_search.addClass("active");
// 			$store_search_span.addClass("active");
// 		}
// 	});

// 	$store_search_form.validate({
// 	    rules: {
// 	        q: {
// 	            required: true,    
// 	            minlength: 2,                        
...
// }); 
/* End */
;; /* /local/templates/main/js/output.js?15990511587316*/
; /* /local/templates/main/js/form-styler/jquery.formstyler.min.js?152243394718307*/
; /* /local/templates/main/js/fancybox/jquery.fancybox.min.js?152455593161486*/
; /* /local/templates/main/components/bitrix/menu/main/script.js?16444986731410*/
; /* /local/components/bitrix/search.title/script.js?15224339479469*/
; /* /local/components/bitrix/search.title/templates/mini_head/script.js?1597683935804*/
